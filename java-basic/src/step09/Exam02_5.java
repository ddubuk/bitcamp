...
public class Exam02_5 {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(c.get(4)); //그 달의 몇 번째 주인지
        System.out.println(c.get(10)); //시(0 ~ 11시까지)
        ...
        System.out.println(c.get(Calendar.WEEK_OF_MONTH)); //그 달의 몇 번째 주인지
        System.out.println(c.get(Calendar.HOUR)); //시(0 ~ 11시까지)
