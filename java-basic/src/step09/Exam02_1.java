...
public class Exam02_1 {
    ...
    public static void main(String[] args) throws Exception {
       ...
       // 따라서 이 메서드를 호하려면 반드시 String 인스턴스의 주소를 줘야 한다.
       char c = s1.charAt(1);   //hello에서 01234니까 e
       ...
       // => 두 문자열을 파라미터로 받아서 연결한 새 문자열을 만든다.
