...
public class Exam02_2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 2) DBMS에 연결하기
        // => DriverManager를 통해 등록된 드라이버 객체를 사용하여 DBMS와 연결한다.
        ...
        java.sql.Connection con = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/java106db?serverTimezone=UTC&useSSL=false&user=ㅓㅁㅍㅁ106&password=1111");
