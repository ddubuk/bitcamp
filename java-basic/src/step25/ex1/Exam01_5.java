...
public class Exam01_5 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //    자동으로 객체가 생성되어 DriverManager에 자동 등록된다.
