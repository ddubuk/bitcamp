...
// InputStream에 상속 받아 InputStream의 가족으로 거듭나다.
// 그러나 InputStream을 상속 받았다고 해서 특별히 그 상속받은 기능을 이용하는 것은 아니다.
// 단지, 같은 InputStream 그룹의 소속되기 위함이다.
// => 이 상속은 기능 상속의 의미로 상속 받은 것이 아니다.
//    같은 그룹으로 묶이기 위함이다.
public class BurfferedInputStream extends InputStream {
